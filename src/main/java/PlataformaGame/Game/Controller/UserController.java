...
public class UserController {
    ...
    //     
    @GetMapping("/{nameUser}")
    public boolean getUser(@PathVariable("nameUser") String nameUser) {

        return servicios.getExistsUser(nameUser);
    }
    
    
    @GetMapping("/{nameUser}/{password}")
    public User getUserAndPassword(@PathVariable("nameUser") String nameUser, @PathVariable("password") String password) {
